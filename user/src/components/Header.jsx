...
export default function Header() {
  return (
    <header className="block bg-slate-300 sm:bg-slate-200 ">
      <div className=" flex  justify-around items-center p-3 gap-4 sm:max-w-7xl sm:justify-evenly sm:gap-18 :max-w-9xl">
        ...
        <form className="flex items-center justify-between  min-w-8 flex-grow bg-slate-100 rounded-md p-1 sm:p-3 sm:rounded-lg sm:max-w-1xl md:max-w-2xl " >
          <input
            type="text"
            placeholder="Search ..."
        ...
        <ul className="flex xs:gap-2 sm:gap-4  md:gap-6 lg:gap-8 xl:gap-10">
          <Link to="/">
